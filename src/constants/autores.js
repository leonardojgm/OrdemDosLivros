...
> *"Um leitor vive mil vidas antes de morrer. O homem que nunca lê vive apenas uma."* - George R.R. Martin
  ...
  },
  {
    id: "george-orwell",
    nome: "George Orwell",
    imagem: "https://ufmg.br/thumbor/VoZ7ldOHDuq3wDi3BbSE4cQ5mSc=/0x0:932x674/932x674/https://ufmg.br/storage/a/e/0/4/ae048209e737d1069f1414e4ee44db53_16075285368036_542074383.jpg",
    biografia: `
# George Orwell

**Eric Arthur Blair**, conhecido pelo pseudônimo **George Orwell**, foi um escritor, ensaísta e jornalista britânico, nascido em 25 de junho de 1903, em Motihari, na Índia Britânica, e falecido em 21 de janeiro de 1950, em Londres, Inglaterra. Ele é amplamente reconhecido por suas obras **"1984"** e **"A Revolução dos Bichos"** (*Animal Farm*), que se tornaram ícones da literatura mundial.

## Primeiros Anos e Formação
Orwell nasceu em uma família de classe média baixa e foi educado em renomadas instituições britânicas, como **Eton College**. Ele trabalhou como oficial da polícia imperial na Birmânia, uma experiência que marcou profundamente suas visões sobre colonialismo e injustiça social, temas recorrentes em suas obras.

## Carreira Literária
Orwell começou sua carreira como jornalista e ensaísta, escrevendo sobre questões sociais e políticas. Sua obra é marcada por uma crítica feroz ao autoritarismo, ao totalitarismo e às desigualdades sociais.

### Principais Obras
1. **"Na Pior em Paris e Londres"** (*Down and Out in Paris and London*) - 1933: Um relato autobiográfico sobre a vida na pobreza.
2. **"Dias na Birmânia"** (*Burmese Days*) - 1934: Uma crítica ao colonialismo britânico.
3. **"O Caminho para Wigan Pier"** (*The Road to Wigan Pier*) - 1937: Um estudo das condições da classe trabalhadora no norte da Inglaterra.
4. **"A Revolução dos Bichos"** (*Animal Farm*) - 1945: Uma sátira alegórica sobre a Revolução Russa e o totalitarismo.
5. **"1984"** - 1949: Um romance distópico que explora temas como vigilância, censura e controle governamental.

## Legado e Influência
Orwell é considerado um dos maiores escritores do século XX. Suas obras continuam sendo amplamente estudadas e citadas por sua relevância política e social. Termos como **"Big Brother"**, **"duplipensar"** e **"1984"** tornaram-se parte do vocabulário cultural global.

## Vida Pessoal
Orwell casou-se duas vezes, primeiro com Eileen O'Shaughnessy, com quem teve um filho adotivo, e depois com Sonia Brownell. Ele lutou contra a tuberculose por grande parte de sua vida adulta, doença que levou à sua morte precoce.

---

> *"Em uma época de engano universal, dizer a verdade é um ato revolucionário."* - George Orwell
        `
},
];
